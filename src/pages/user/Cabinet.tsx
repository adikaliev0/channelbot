    ...
    <div className="flex flex-col min-h-full pb-8">
      ...
      <header className="sticky top-0 z-40 bg-zinc-950/80 backdrop-blur-xl border-b border-zinc-800/50 pt-safe px-4 pb-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-lg font-bold tracking-tight">Elden Lord</h1>
            <p className="text-[11px] font-mono text-zinc-500 uppercase tracking-wider">ID: 84910293</p>
          </div>
        </div>
      </header>
      ...
      <div className="p-4 space-y-6">
        ...
        <div className="grid grid-cols-2 gap-3">
          <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-4 flex flex-col items-center justify-center text-center">
            ...
            <div className="text-2xl font-light tracking-tight text-white mb-0.5">14</div>
          ...
          <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-4 flex flex-col items-center justify-center text-center">
            ...
            <div className="text-2xl font-light tracking-tight text-white mb-0.5">3</div>
